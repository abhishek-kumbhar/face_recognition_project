    ...
    void searchBtnPressed(MouseEvent event) {
        ...
        if (filterSelector.getValue() != null && !filterSelector.getValue().isEmpty()){
            ...
            if (!searchBar.getText().isEmpty()){
                ...
                if (filterSelector.getValue().equals("StudentID")){
                    ...
                    if (isValidPhoneNumber(searchBar.getText())) {
                        ...
                        while (cursor.hasNext()) {
                            ...
                            dialogDisplay(stackPane, "Successfully deleted student with StudentID : "+ searchQuery);


                        }

                    } else {
                        dialogDisplay(stackPane, "Please enter a valid Student ID to search ...");
                ...
                if (filterSelector.getValue().equals("Primary no.")){
                    ...
                    if (isValidPhoneNumber(searchBar.getText())) {
                        ...
                        while (cursor.hasNext()) {
                            ...
                            dialogDisplay(stackPane, "Successfully deleted student with primary number : "+ searchQuery);
